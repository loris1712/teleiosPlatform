...
const Step14 = ({ prevStep, nextStep, handleFormData, values }) => {
  ...
  const handlInputData2 = (input) => (e) => {
    ...
    values.massimizzare = e.target.name;
  };
  ...
  const submitFormData = (e) => {
    ...
    if (validator.isEmpty(values.massimizzare)) {
      setError(true);
    } else {
      nextStep();
    }
        ...
        <Card className={cn("card", styles.card)}>
          <Card.Body>
            ...
            <div className={cn("title", styles.title)}>
              ...
              Quale parte del corpo vuoi massimizzare la tonicità, aumento della
              massa muscolare?
            </div>
                ...
                {["radio"].map((type) => (
                  ...
                  >
                    <Form.Check
                      ...
                      name="Petto"
                      onChange={handlInputData2("massimizzare")}
                    />
                    <Form.Check
                      type={type}
                      id={`default-${type}`}
