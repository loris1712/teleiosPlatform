...
const Step15_2 = ({ prevStep, nextStep, handleFormData, values }) => {
        ...
        <Card className={cn("card", styles.card)}>
          <Card.Body>
            ...
            <div className={cn("title", styles.title)}>
              <div className={cn("number", styles.number)}>{step + 19}</div>
              Fai pasti <strong>&nbsp;regolarmente fuori casa?</strong>
            </div>
            <Form className={cn("form", styles.form)} onSubmit={submitFormData}>
              <Form.Group className="mb-3">
                <Form.Control
                  ...
                  name="pasti_fuori"
                  defaultValue={values.pasti_fuori}
                  type="text"
                  placeholder="Risposta non obbligatoria"
                  className={cn("input", styles.input)}
                  onChange={handleFormData("pasti_fuori")}
                />
                {error ? (
                  <Form.Text
