        ...
        <Card className={cn("final", styles.final)}>
          <div style={{ display: "flex", width: "100%" }}>
            ...
            >
              ...
              <a href="https://buy.stripe.com/test_5kA2aTav11OLaBy4gm">
              ...
              <a href="https://buy.stripe.com/test_fZe16PgTpdxt10YfZ3">
              <div className={cn("packPayment", styles.packPayment)}>
                <div>
                  <p
                    style={{
              ...
              <a href="https://buy.stripe.com/test_8wMcPx5aHbpleROdQU">
              <div className={cn("packPayment", styles.packPayment)}>
                <div>
                  <p
                    style={{
