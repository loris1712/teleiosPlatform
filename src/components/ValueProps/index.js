...
const items = [
  {
    title: "Creazione della scheda con dei professionisti",
    content:
      "In pochi passaggi, puoi fornire le tue informazioni ai nostri professionisti che creeranno la scheda per te rispettando le tue necessità e le tue preferenze.",
  ...
  {
    title: "Supporto dei professionisti online senza attese",
    content:
      "Dopo aver acquistato uno dei pacchetti potrai essere supportato da uno dei nostri professionisti online.",
  ...
  {
    title: "Continuo aggiornamento della scheda",
    content:
      "Rispetto a quale pacchetto hai scelto potrai avere continui aggiornamenti sulla tua scheda per migliorare sempre di più.",
      ...
      <div className={cn("container", styles.container)}>
        <div className={styles.head}>
          <div className={cn("stage-small", styles.stage)}>
            La scheda online su misura per te
          </div>
          <div className={cn("h2", styles.title)}>
            Perchè scegliere Teleios?
          </div>
        </div>
